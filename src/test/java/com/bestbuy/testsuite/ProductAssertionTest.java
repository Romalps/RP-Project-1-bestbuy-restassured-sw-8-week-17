...
public class ProductAssertionTest {
    ...
    @Test
    public void verifyTheProductId150115InsideCategoriesOfTheThirdNameIsHoseHoldBatteries() {
    ...
    @Test
    public void verifyTheCategoriesSecondNameHouseWaresOfProductId333179() {
    ...
    @Test
    public void verifyTheProductNameDuracellDBatteriesOf6thProduct() {
        response.body("data[5].name", equalTo("Duracell - D Batteries (4-Pack)"));
    }

    //19. Verify the ProductId = 333179 for the 9th product
    @Test
    public void verifyTheProductId333179ForThe9thProduct() {
